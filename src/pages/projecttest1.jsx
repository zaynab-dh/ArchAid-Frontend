...
const ProjectTest1 = () => {
    ...
    const [tfh, setTfh] = useState('');
    const [nbf, setNbf] = useState('');
    const [sitear, setSitear] = useState('');
    const [grflar, setGrflar] = useState('');
    const [tyflar, setTyflar] = useState('');
    const [balcar, setBalcar] = useState('');
    const [stairar, setStairar] = useState('');
    const [elevar, setElevar] = useState('');
    ...
    const handleSubmit = async (e) => {
        ...
        let maxHeight = state['613f5041c506768e700e1e0b']
        let height = 0;
        let g = parseInt(gfh)
        height = g + (tfh * nbf)
        console.log(height)
        ...
        let maxSurfaceInvestment = state['613f5009c506768e700e1e09']
        let maxSurfaceArea = 0;
        maxSurfaceArea = maxSurfaceInvestment * sitear;
        console.log(maxSurfaceArea)
       


        let maxGeneralInvestment = state['613f4f6dc506768e700e1e07']
        ...
        if (finalArea > maxGeneralArea) {
            finalDescription += "you depassed the max general investment rate! \n"
        }

        if (grflar > maxSurfaceArea || tyflar > maxSurfaceArea) {
            finalDescription += "you depassed the max surface investment rate! \n"
        }
        if (height > maxHeight) {
            finalDescription += "you depassed the max height ! \n"
                ...
                <div>
                    ...
                    <center>
                        <form className="pt-3" onSubmit={handleSubmit}>
                            ...
                            <div className="form-group">
                                <input onChange={(e) => setGfh(e.target.value)} type="number" className="form-control form-control-lg" name='groundFloorHeight' id="groundFloorHeight" placeholder="Ground Floor Height (m)" />
                            </div>

                            <div className="form-group">
                                <input onChange={(e) => setTfh(e.target.value)} type="number" className="form-control form-control-lg" name='typicalFloorHeight' id="typicalFloorHeight" placeholder="Typical Floor Height (m)" />
                            </div>

                            <div className="form-group">
                                <input onChange={(e) => setNbf(e.target.value)} type="number" className="form-control form-control-lg" name='numberOfFloors' id="numberOfFloors" placeholder="Number Of Floors" />
                            </div>



                            <div className="form-group">
                                <input onChange={(e) => setSitear(e.target.value)} type="number" className="form-control form-control-lg" name='siteArea' id="siteArea" placeholder="Site area (m2)" />
                            </div>

                            <div className="form-group">
                                <input onChange={(e) => setGrflar(e.target.value)} type="number" className="form-control form-control-lg" name='groundFloorArea' id="groundFloorArea" placeholder="Ground Floor Area (m2)" />
                            </div>

                            <div className="form-group">
                                <input onChange={(e) => setTyflar(e.target.value)} type="number" className="form-control form-control-lg" name='typicalFloorArea' id="typicalFloorArea" placeholder="Typical Floor Area (m2)" />
                            </div>

                            <div className="form-group">
                                <input onChange={(e) => setBalcar(e.target.value)} type="number" className="form-control form-control-lg" name='balconiesArea' id="balconiesArea" placeholder="Balconies Area (m2)" />
                            </div>

                            <div className="form-group">
                                <input onChange={(e) => setStairar(e.target.value)} type="number" className="form-control form-control-lg" name='stairsArea' id="stairsArea" placeholder="Stairs Area (m2)" />
                            </div>

                            <div className="form-group">
                                <input onChange={(e) => setElevar(e.target.value)} type="number" className="form-control form-control-lg" name='elevatorsArea' id="elevatorsArea" placeholder="Elevators Area (m2)" />
                            </div>
